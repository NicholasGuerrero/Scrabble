...
/**
 * 4 This class computes permutations of a string. 5
 */
public class Permutations {
     ...
     /**
      * Gets all permutations of a given word. @param word the string to
      * permute @return a list of all permutations
      */
